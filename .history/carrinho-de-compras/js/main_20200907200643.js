...
function subTotal(value, amount, discount){
	...
	var discountO = total * (discount / 100);
	var subTotal = total * (discount / 100);
...
function validation(){
	...
	if(subTotal === ""){
		errors += '<p>Fill out a subTotal</p>';
	}else if(subTotal != parseFloat(subTotal)){
		errors += '<p>Fill out a valid subTotal</p>';
	}
