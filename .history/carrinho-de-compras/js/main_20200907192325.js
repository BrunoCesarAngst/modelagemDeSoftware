...
function setList(list){
	...
	for(var key in list){
		...
		'</td><td>'
			+ subTotal(list[key].subTotal) +'</td><td><button class="btn btn-default" onclick="setUpdate('+key+');">Edit</button> <button class="btn btn-default" onclick="deleteData('+key+');">Delete</button></td></tr>';
	}
	table += '</tbody>';
