...
//somando total
function getTotal(list, sst){
	var total = 0;
	var st = 0;
	var sts = 0;
	for(var key in list){
		sts = list[key].subTotal
		st = somaSubTotal(list[key].value, list[key].amount, list[key].discount);
		// st = sts
		total += list[key].subTotal
		console.log(sts)
		console.log(st)
		console.log(total)
	}
...
function setList(list){
	...
	for(var key in list){
		...
		'</td><td>'
			+ subTotal(list[key].value, list[key].amount, list[key].discount) +
...
//formatando o desconto
var sst
sst = function somaSubTotal(value, amount, discount){
	var total = value * amount;
	var discountOfValue = total * (discount / 100);
	var subTotal = total - discountOfValue;
	return somaSubTotal;
