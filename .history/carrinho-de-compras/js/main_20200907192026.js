...
function setList(list){
	...
	Description</td><td>Amount</td><td>Value</td><td>Discount</td><td>Subtotal</td><td>Action</td></tr></thead><tbody>';
	for(var key in list){
		table += '<tr><td>'+ formatDesc(list[key].desc) +'</td><td>'+ formatAmount(list[key].amount) +'</td><td>'+ formatValue(list[key].value) +'</td><td>'+ formatDiscount(list[key].discount) +'</td><td>'+ subTotal(list[key].subTotal) +'</td><td><button class="btn btn-default" onclick="setUpdate('+key+');">Edit</button> <button class="btn btn-default" onclick="deleteData('+key+');">Delete</button></td></tr>';
	}
	table += '</tbody>';
...
function updateData(){
	...
	var value = document.getElementById("value").value;
	var discount = document.getElementById("discount").value;
	var discount = document.getElementById("subTotal").value;
